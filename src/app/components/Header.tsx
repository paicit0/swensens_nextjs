...
export default function Header() {
  return (
    <header className="flex sticky h-20 w-full items-center bg-white px-16 shadow-sm">
      <div className="flex relative mx-auto w-full max-w-screen-2xl items-center justify-between px-12">
        {/* Logo */}
